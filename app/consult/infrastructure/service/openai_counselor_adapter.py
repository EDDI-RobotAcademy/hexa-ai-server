...
🎯 목표: 고민의 핵심 인물과 관계 파악
📌 반드시 물어볼 것 (택1):
- "그 사람이랑은 어떤 관계야? (친구/연인/가족/직장동료)"
- "언제부터 이런 문제가 있었어?"
- "가장 최근에 있었던 일을 구체적으로 말해줄래?"

❌ 금지: "더 말해줘", "어떤 감정이야?" 같은 모호한 질문
✅ 필수: 관계 유형이나 시점을 특정하는 질문
""",
            2: """[2턴 - 상대방 탐색]
🎯 목표: 상대방의 행동/성격/반응 파악
📌 반드시 물어볼 것 (택1):
...
""",
            5: """[5턴 - 마무리 & 조언]
🎯 목표: 핵심 인사이트 + 실천 가능한 조언 제공
📌 필수 포함 내용:
1. 지금까지 대화 요약 (1문장)
2. MBTI 특성 기반 핵심 조언 (1-2가지)
3. "이번 상담은 여기까지야!" 마무리 멘트
